// Theme: stacklink-dark. Dark palette for roadmap.
export const THEME = {
  background: "#0A0E1A",
  foreground: "#F5F7FA",
  ...
  connectorPalette: { drive: "#4285F4", slack: "#ECB22E", github: "#C9D1D9", notion: "#FFFFFF", onedrive: "#28A8EA", salesforce: "#00A1E0", jira: "#0052CC", confluence: "#172B4D", teams: "#5059C9", linear: "#5E6AD2" }
} as const;
